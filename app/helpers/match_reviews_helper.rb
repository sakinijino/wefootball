module MatchReviewsHelper
  ...
  def team_image_links_of_match(m, host_option={}, guest_option={}, host_link_option={}, guest_link_option={})
    if m.class == OfficialMatch
      host_team_icon = official_team_image_link(m.host_team, {:thumb => :small}.merge(host_option), host_link_option)
      guest_team_icon = official_team_image_link(m.guest_team, {:thumb => :small}.merge(guest_option), guest_link_option)
    elsif m.class == Match
